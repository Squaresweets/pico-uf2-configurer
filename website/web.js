...
function showMSG() {
  if (infoMsg) document.getElementById("currconfig").textContent = infoMsg;
}
...
function applyPatch() {
  wrap(() => {
    ...
    if (!currUF2)
      log(
        "You have to drop a UF2 or BIN file with bootloader above before applying patches."
      );
    else if (!newcfg) log("You didn't give any patch to apply.");
    else {
